...
export const LoginPopup = ({setShowLogin}) => {
    ...
    // })updates simultaneously as data gets updated
    ...
    <div className='login-popup'>
        <form onSubmit={onLogin} className="login-popup-container">
            ...
            <div className="login-popup-inputs">
                ...
                <input name='password' type='password'onChange={onChangeHandler} value={data.password} placeholder='Type Your Password' required/>
            </div>
